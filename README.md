...
### 3. 애니메이션 파이프라인 구조 이해 부족으로 인한 불필요한 변환
...
### 7. Transform, 회전, 짐벌락을 다루며 쌓은 수학적 감각
...
### 2. Actor 자체 Transform 도입과 Root 이관
