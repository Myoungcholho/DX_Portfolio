...
void UStaticMeshComponent::UpdateConstantBuffers(ComPtr<ID3D11Device>& device, ComPtr<ID3D11DeviceContext>& context)
{
    UPrimitiveComponent::UpdateConstantBuffers(device, context);
...
void UStaticMeshComponent::Render(ComPtr<ID3D11DeviceContext>& context)
{
